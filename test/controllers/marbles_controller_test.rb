...
class MarblesControllerTest < ActionController::TestCase
  ...
  test "should create marble" do
    assert_difference('Marble.count') do
      post :create, marble: { marble_name: @marble.marble_name, marble_text: @marble.marble_text, user_id: @marble.user_id }
    end
  ...
  test "should update marble" do
    patch :update, id: @marble, marble: { marble_name: @marble.marble_name, marble_text: @marble.marble_text, user_id: @marble.user_id }
    assert_redirected_to marble_path(assigns(:marble))
  end
